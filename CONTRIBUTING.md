...
Discussion around sbt-compendium happens in the [Gitter channel](https://gitter.im/higherkindness/sbt-compendium) as well as on
[GitHub issues](https://github.com/higherkindness/sbt-compendium/issues) and [pull requests](https://github.com/higherkindness/sbt-compendium/pulls).

Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about
the code. Pull requests are also welcome.

People are expected to follow the [Scala Code of Conduct](https://typelevel.org/code-of-conduct.html) when discussing sbt-compendium on the Github page, Gitter channel, or other venues.
...
sbt-compendium follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
